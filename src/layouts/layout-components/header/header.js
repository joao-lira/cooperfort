...
import { PATH_ROUTER_LOGIN } from '../../../constants/constants'
...
class Header extends React.Component {
  ...
  verifyUserLogged = () => {
    ...
    //   return <Redirect to={PATH_ROUTER_LOGIN} />
    // }
  }
            ...
            <Nav className="ml-auto float-right" navbar>
              ...
              <UncontrolledDropdown nav inNavbar>
                <DropdownToggle nav caret className="pro-pic">
                  <img
                    src="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/app-assets/images/profile/user-uploads/social-2.jpg"
                    alt="user"
                    className="rounded-circle"
                    width="31"
                  />
                ...
                <DropdownMenu right className="user-dd">
                  <div className="d-flex no-block align-items-center p-3 mb-2 border-bottom">
                    ...
                    <div className="ml-3">
                      <h4 className="mb-0">Mariane Morais</h4>
                      <p className="text-muted mb-0">marianemorais@gmail.com</p>
